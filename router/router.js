...
const { houseAdd, getHouse, getSpottedList, getSpottedListSuccess, getSpottedListUnsuccess, listingsByAgencyAgent, singleHouseDetails, getHouseListByAdmin, getAvailableHouse, getHouseListByAgent } = require('../controllers/houseControllers');
